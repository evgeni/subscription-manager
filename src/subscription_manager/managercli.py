...
class ListCommand(CliCommand):
    ...
    def __init__(self):
        ...
        self.parser.add_option('--after', dest="after",
                               help=_("show pools that are active on or after the given date; only used --available and --all"))
    ...
    def _validate_options(self):
        ...
        if self.options.after and not self.options.all:
            system_exit(os.EX_USAGE, _("Error: --after is only applicable with --all"))
